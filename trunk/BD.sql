...
insert  into `inscripcion_curso`(`idmatricula`,`idcurso`,`idalumno`,`vez`,`iddocente`,`promedio`) values ('M00001','091211','A0001',1,'D0006',15),('M00001','091214','A0001',1,'D0003',13),('M00001','091215','A0001',1,'D0001',0),('M00001','091212',NULL,1,'D0006',NULL);
...
insert  into `usuarios`(`id_usuario`,`id_pais`,`nombre_usuario`,`apellido_usuario`,`edad_usuario`,`email_usuario`,`observacion_usuario`) values (1,3,'juan carlos','silva',15,'tibiyacks@gmail.com','gdfgdfgfdgdg');
