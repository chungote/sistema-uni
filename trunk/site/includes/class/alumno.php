...
class alumno{
    ...
    $qinsertar = $cn->query("CALL paAlumnosInsertar('".$nombre."', '".$ape."', '".$sex."', '".$dni."', '".$fnac."', '".$dir."', '".$tel."', '".$celu."', '".$mail."')");
...
public function modificar($nombre,$apellidos,$sexo,$dni,$fechan,$direccion,$telefono,$celular,$email,$id)
	{
		include '../conexion.php';
